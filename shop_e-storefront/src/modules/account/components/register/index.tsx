...
const Register = ({ setCurrentView }: Props) => {
  ...
  return (
    <div className="max-w-sm flex flex-col items-center" data-testid="register-page">
      <h1 className={`${styles.welcom_user} text-large-semi uppercase mb-6 `}>
        Bienvenue dans la boutique IRT2
      </h1>
      <p className="text-center text-base-regular text-ui-fg-base mb-4">
          cree votre compte et devenez membre de notre boutique
      </p>
      <form className="w-full flex flex-col" action={formAction}>
        ...
        <span className="text-center text-ui-fg-base text-small-regular mt-6">
          En creant un compte vous accepter nos condition d'utilisateur&apos;s{" "}
          <LocalizedClientLink
